...
public class ItemManagerScript : MonoBehaviour {
    ...
    void Start () {
        ...
        InventoryItemList.Add(new InventoryItem(16, 1, 200, InventoryItem.ItemType.weapon, "Red Staff", "Red Staves", InventoryItem.WeaponType.staff, 2, "redstaff", true));
        InventoryItemList.Add(new InventoryItem(17, 1, 500, InventoryItem.ItemType.weapon, "Blue Staff", "Blue Staves", InventoryItem.WeaponType.staff, 5, "bluestaff", true));
    }
