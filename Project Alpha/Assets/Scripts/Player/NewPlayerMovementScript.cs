...
public class PlayerMovementScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (grounded)
        {
            ...
            if (camera1.transform.gameObject.transform.GetComponent<NewCameraScript>().inFirstPerson == true)
            {
        ...
        if (camera1.transform.gameObject.transform.GetComponent<NewCameraScript>().inFirstPerson == false)
        {
